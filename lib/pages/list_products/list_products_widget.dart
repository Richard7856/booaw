  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ProdutsRecord>>(
      stream: queryProdutsRecord(
        queryBuilder: (produtsRecord) =>
            produtsRecord.where('categoria', isEqualTo: widget.categoria),
      ),
      builder: (context, snapshot) {
        ...
        List<ProdutsRecord> listProductsProdutsRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: Color(0xFFF1F4F8),
          body: SafeArea(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return Wrap(
                                            ...
                                            children: List.generate(
                                                wrapProdutsRecordList.length,
                                                (wrapIndex) {
                                              final wrapProdutsRecord =
                                                  wrapProdutsRecordList[
                                                      wrapIndex];
                                              return Padding(
