...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF8FF97);
  late Color secondary = const Color(0xFF7DE880);
  late Color tertiary = const Color(0xFF7B8DF1);
  late Color alternate = const Color(0xFF000000);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xFFF96B68);
  late Color primaryBackground = const Color(0xFFFAFCFF);
  late Color secondaryBackground = const Color(0xFFF4F9FC);
  ...
  late Color seashell = Color(0xFFFAEFE8);
  late Color white = Color(0xFFFEFCFC);
  late Color mistyRose = Color(0xFFECD4D4);
  late Color palePurple = Color(0xFFE4D4F6);
  late Color timberwolf = Color(0xFFD2C3BD);
}
